...
class Ui_batch(object):
    def setupUi(self, batch):
        ...
        self.boxParameter.setEnabled(False)
        ...
        self.barProcess = QtWidgets.QProgressBar(batch)
        self.barProcess.setProperty("value", 0)
        self.barProcess.setObjectName("barProcess")
        self.layoutProcess.addWidget(self.barProcess)
        ...
        batch.setTabOrder(self.cbHead, self.DispSpin)
        batch.setTabOrder(self.DispSpin, self.foutCSV)
        batch.setTabOrder(self.foutCSV, self.DispFile)
        batch.setTabOrder(self.DispFile, self.listFiles)
